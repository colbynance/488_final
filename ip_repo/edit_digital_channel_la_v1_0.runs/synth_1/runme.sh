...
HD_PWD='C:/Temp/sa2-final/ip_repo/edit_digital_channel_la_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_channel_la_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_channel_la_v1_0.tcl
