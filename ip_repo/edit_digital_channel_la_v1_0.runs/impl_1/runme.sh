...
HD_PWD='C:/Temp/sa2-final/ip_repo/edit_digital_channel_la_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_channel_la_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_channel_la_v1_0.tcl -notrace
