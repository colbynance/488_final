...
HD_PWD='C:/Temp/sa2-final/SA2_final_project/SA2_final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_proj_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_proj_wrapper.tcl -notrace
