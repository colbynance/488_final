...
HD_PWD='C:/Temp/sa2-final/SA2_final_project/SA2_final_project.runs/final_proj_analog_channel_fr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_proj_analog_channel_fr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_proj_analog_channel_fr_0_0.tcl
