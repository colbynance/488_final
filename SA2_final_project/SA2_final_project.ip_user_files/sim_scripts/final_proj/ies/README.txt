...
#
# Generated by export_simulation on Fri Apr 24 15:28:53 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './final_proj.sh' script.

./final_proj.sh -reset_run
...
./final_proj.sh -noclean_files

For more information on the script, please type './final_proj.sh -help'.
