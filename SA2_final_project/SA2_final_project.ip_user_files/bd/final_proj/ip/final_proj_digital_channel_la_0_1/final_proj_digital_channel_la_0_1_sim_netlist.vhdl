...
-- Command     : write_vhdl -force -mode funcsim -rename_top final_proj_digital_channel_la_0_1 -prefix
--               final_proj_digital_channel_la_0_1_ final_proj_digital_channel_la_0_0_sim_netlist.vhdl
...
entity final_proj_digital_channel_la_0_1_buffer is
  port (
...
end final_proj_digital_channel_la_0_1_buffer;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_buffer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1_downsample is
  port (
...
end final_proj_digital_channel_la_0_1_downsample;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_downsample is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1_sig_streamer is
  port (
...
end final_proj_digital_channel_la_0_1_sig_streamer;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_sig_streamer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1_trigger is
  port (
...
end final_proj_digital_channel_la_0_1_trigger;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_trigger is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1_analyzer_channel is
  port (
    buf_do_o : out STD_LOGIC_VECTOR ( 0 to 0 );
    buffer_addr_o : out STD_LOGIC_VECTOR ( 9 downto 0 );
    buffer_di_o : out STD_LOGIC_VECTOR ( 0 to 0 );
...
end final_proj_digital_channel_la_0_1_analyzer_channel;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_analyzer_channel is
...
buff: entity work.final_proj_digital_channel_la_0_1_buffer
     port map (
      D(0) => D(0),
...
downsamp: entity work.final_proj_digital_channel_la_0_1_downsample
     port map (
      D(0) => downsamp_n_3,
      E(0) => downsamp_n_1,
      Q(0) => Q(0),
...
stream: entity work.final_proj_digital_channel_la_0_1_sig_streamer
     port map (
      E(0) => downsamp_n_1,
      Q(0) => Q(0),
      RAM_reg(0) => RAM_reg(0),
...
trig: entity work.final_proj_digital_channel_la_0_1_trigger
     port map (
      D(0) => downsamp_n_3,
      E(0) => downsamp_n_2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1_digital_channel_la_v1_0_S00_AXI is
  port (
...
end final_proj_digital_channel_la_0_1_digital_channel_la_v1_0_S00_AXI;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_digital_channel_la_v1_0_S00_AXI is
...
ch: entity work.final_proj_digital_channel_la_0_1_analyzer_channel
     port map (
      D(0) => ch_n_17,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1_digital_channel_la_v1_0 is
  port (
    new_sample_o : out STD_LOGIC;
    sample_done_o_reg : out STD_LOGIC;
    trig_o_reg : out STD_LOGIC;
...
end final_proj_digital_channel_la_0_1_digital_channel_la_v1_0;

architecture STRUCTURE of final_proj_digital_channel_la_0_1_digital_channel_la_v1_0 is
begin
digital_channel_la_v1_0_S00_AXI_inst: entity work.final_proj_digital_channel_la_0_1_digital_channel_la_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity final_proj_digital_channel_la_0_1 is
  port (
    sig_i : in STD_LOGIC;
    trig_ext_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of final_proj_digital_channel_la_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of final_proj_digital_channel_la_0_1 : entity is "final_proj_digital_channel_la_0_0,digital_channel_la_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of final_proj_digital_channel_la_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of final_proj_digital_channel_la_0_1 : entity is "digital_channel_la_v1_0,Vivado 2020.1";
end final_proj_digital_channel_la_0_1;

architecture STRUCTURE of final_proj_digital_channel_la_0_1 is
...
inst: entity work.final_proj_digital_channel_la_0_1_digital_channel_la_v1_0
     port map (
