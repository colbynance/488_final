...
----------------------------------------------------------------------------------
--Command: generate_target bd_289d.bd
--Design : bd_289d
...
entity bd_289d is
  ...
  attribute CORE_GENERATION_INFO of bd_289d : entity is "bd_289d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_289d,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_289d : entity is "final_proj_system_ila_0_1.hwdef";
end bd_289d;

architecture STRUCTURE of bd_289d is
  component bd_289d_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component bd_289d_ila_lib_0;
  component bd_289d_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
    ...
    slot_0_axi_rvalid : in STD_LOGIC;
    slot_0_axi_rready : in STD_LOGIC;
    m_slot_0_axi_awaddr : out STD_LOGIC_VECTOR ( 4 downto 0 );
    ...
    m_slot_0_axi_araddr : out STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  end component bd_289d_g_inst_0;
  component bd_289d_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_289d_slot_0_aw_0;
  component bd_289d_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_289d_slot_0_w_0;
  component bd_289d_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_289d_slot_0_b_0;
  component bd_289d_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_289d_slot_0_ar_0;
  component bd_289d_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_289d_slot_0_r_0;
  signal Conn_ARADDR : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal Conn_ARPROT : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal Conn_ARREADY : STD_LOGIC;
  signal Conn_ARVALID : STD_LOGIC;
  signal Conn_AWADDR : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  signal net_slot_0_axi_araddr : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  signal net_slot_0_axi_awaddr : STD_LOGIC_VECTOR ( 4 downto 0 );
...
begin
  ...
  Conn_AWADDR(4 downto 0) <= SLOT_0_AXI_awaddr(4 downto 0);
  ...
  probe6_1(0) <= probe6(0);
  resetn_1 <= resetn;
g_inst: component bd_289d_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
      m_slot_0_axi_ar_cnt(1 downto 0) => net_slot_0_axi_ar_cnt(1 downto 0),
      m_slot_0_axi_araddr(4 downto 0) => net_slot_0_axi_araddr(4 downto 0),
      ...
      m_slot_0_axi_awaddr(4 downto 0) => net_slot_0_axi_awaddr(4 downto 0),
...
ila_lib: component bd_289d_ila_lib_0
     port map (
      ...
      probe16(31 downto 0) => net_slot_0_axi_rdata(31 downto 0),
      probe17(1 downto 0) => net_slot_0_axi_rresp(1 downto 0),
      probe18(31 downto 0) => net_slot_0_axi_wdata(31 downto 0),
      probe19(3 downto 0) => net_slot_0_axi_wstrb(3 downto 0),
      probe2(31 downto 0) => probe2_1(31 downto 0),
      probe20(1 downto 0) => net_slot_0_axi_aw_ctrl(1 downto 0),
      probe21(1 downto 0) => net_slot_0_axi_w_ctrl(1 downto 0),
      probe22(1 downto 0) => net_slot_0_axi_b_ctrl(1 downto 0),
      probe23(1 downto 0) => net_slot_0_axi_ar_ctrl(1 downto 0),
      probe24(1 downto 0) => net_slot_0_axi_r_ctrl(1 downto 0),
