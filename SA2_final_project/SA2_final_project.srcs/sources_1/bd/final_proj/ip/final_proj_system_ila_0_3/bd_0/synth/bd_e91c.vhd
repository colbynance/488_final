...
----------------------------------------------------------------------------------
--Command: generate_target bd_e91c.bd
--Design : bd_e91c
...
architecture STRUCTURE of bd_e91c is
  component bd_e91c_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_e91c_g_inst_0;
  component bd_e91c_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e91c_slot_0_aw_0;
  component bd_e91c_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e91c_slot_0_w_0;
  component bd_e91c_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e91c_slot_0_b_0;
  component bd_e91c_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e91c_slot_0_ar_0;
  component bd_e91c_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e91c_slot_0_r_0;
  ...
  signal probe11_1 : STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  signal probe9_1 : STD_LOGIC_VECTOR ( 4 downto 0 );
...
begin
  ...
  probe11_1(6 downto 0) <= probe11(6 downto 0);
  probe1_1(0) <= probe1(0);
  probe2_1(0) <= probe2(0);
  probe3_1(0) <= probe3(0);
  probe4_1(0) <= probe4(0);
  ...
  probe7_1(0) <= probe7(0);
  probe8_1(0) <= probe8(0);
  probe9_1(4 downto 0) <= probe9(4 downto 0);
  resetn_1 <= resetn;
...
ila_lib: component bd_e91c_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
      probe10(0) => probe10_1(0),
      probe11(6 downto 0) => probe11_1(6 downto 0),
      probe12(1 downto 0) => net_slot_0_axi_ar_cnt(1 downto 0),
      probe13(4 downto 0) => net_slot_0_axi_araddr(4 downto 0),
      probe14(2 downto 0) => net_slot_0_axi_arprot(2 downto 0),
      probe15(1 downto 0) => net_slot_0_axi_aw_cnt(1 downto 0),
      probe16(4 downto 0) => net_slot_0_axi_awaddr(4 downto 0),
      probe17(2 downto 0) => net_slot_0_axi_awprot(2 downto 0),
      ...
      probe7(0) => probe7_1(0),
      probe8(0) => probe8_1(0),
      probe9(4 downto 0) => probe9_1(4 downto 0)
    );
