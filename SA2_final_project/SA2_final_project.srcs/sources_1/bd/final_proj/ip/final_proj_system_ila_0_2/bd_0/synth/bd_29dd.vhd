...
----------------------------------------------------------------------------------
--Command: generate_target bd_29dd.bd
--Design : bd_29dd
...
entity bd_29dd is
  ...
  attribute CORE_GENERATION_INFO of bd_29dd : entity is "bd_29dd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_29dd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_29dd : entity is "final_proj_system_ila_0_2.hwdef";
end bd_29dd;

architecture STRUCTURE of bd_29dd is
  component bd_29dd_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 31 downto 0 );
    probe1 : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component bd_29dd_ila_lib_0;
  component bd_29dd_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_29dd_g_inst_0;
  component bd_29dd_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29dd_slot_0_aw_0;
  component bd_29dd_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29dd_slot_0_w_0;
  component bd_29dd_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29dd_slot_0_b_0;
  component bd_29dd_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29dd_slot_0_ar_0;
  component bd_29dd_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_29dd_slot_0_r_0;
...
begin
  ...
  probe6_1(0) <= probe6(0);
  resetn_1 <= resetn;
g_inst: component bd_29dd_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_29dd_ila_lib_0
     port map (
      clk => clk_1,
