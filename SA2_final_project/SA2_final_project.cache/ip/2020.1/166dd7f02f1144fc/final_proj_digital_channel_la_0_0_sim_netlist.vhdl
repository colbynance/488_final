...
\buffer_addr_o[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[1]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[2]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[3]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[4]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[5]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[6]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[7]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[8]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\buffer_addr_o[9]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer is
  port (
    ...
    buffer_di_o_reg_0 : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer is
  ...
  signal buffer_di_o_i_1_n_0 : STD_LOGIC;
...
buffer_di_o_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => buffer_di_o_reg_n_0,
      I1 => buffer_di_o_reg_0(0),
      O => buffer_di_o_i_1_n_0
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_analyzer_channel is
  port (
    ...
    s00_axi_aclk : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    buffer_di_o_reg : in STD_LOGIC_VECTOR ( 0 to 0 );
...
buff: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_buffer
     port map (
      D(0) => D(0),
      Q(0) => Q(0),
      RAM_reg_0(0) => buffer_di_o_reg(0),
      RAM_reg_1(9 downto 0) => RAM_reg(9 downto 0),
      buf_do_o(0) => buf_do_o(0),
      buffer_addr_o(9 downto 0) => buffer_addr_o(9 downto 0),
      buffer_di_o(0) => \^buffer_di_o\(0),
      buffer_we_o(0) => buffer_we_o(0),
...
stream: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer
     port map (
      ...
      SR(0) => SR(0),
      buffer_di_o(0) => \^buffer_di_o\(0),
      buffer_di_o_reg_0(0) => buffer_di_o_reg(0),
      s00_axi_aclk => s00_axi_aclk,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_digital_channel_la_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \buffer_di_o[10]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \buffer_di_o[11]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \buffer_di_o[12]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \buffer_di_o[13]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \buffer_di_o[14]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \buffer_di_o[15]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \buffer_di_o[16]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \buffer_di_o[17]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \buffer_di_o[18]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \buffer_di_o[19]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \buffer_di_o[1]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \buffer_di_o[20]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \buffer_di_o[21]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \buffer_di_o[22]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \buffer_di_o[23]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \buffer_di_o[24]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \buffer_di_o[25]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \buffer_di_o[26]_INST_0\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \buffer_di_o[2]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \buffer_di_o[30]_INST_0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \buffer_di_o[3]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \buffer_di_o[4]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \buffer_di_o[5]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \buffer_di_o[6]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \buffer_di_o[7]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \buffer_di_o[8]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \buffer_di_o[9]_INST_0\ : label is "soft_lutpair6";
begin
...
ch: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_analyzer_channel
     port map (
      ...
      RAM_reg_0(0) => slv_reg6(0),
      SR(0) => ch_n_13,
      buf_do_o(0) => buf_do_o(0),
      buffer_addr_o(9 downto 0) => buffer_addr_o(9 downto 0),
      buffer_di_o(0) => buffer_di_o(0),
      buffer_di_o_reg(0) => slv_reg0(0),
      buffer_we_o(0) => buffer_we_o(0),
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
      s00_axi_wdata(0) => s00_axi_wdata(0),
...
\slv_reg5[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
