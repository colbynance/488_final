...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer is
  port (
    ...
    buffer_we_o_reg_1 : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer is
  ...
  attribute SOFT_HLUTNM of \buf_addr[10]_i_3\ : label is "soft_lutpair4";
...
\buf_addr[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => buffer_we_o_reg_0,
      I2 => buffer_we_o_reg_1,
      I3 => Q(0),
...
sample_done_o_i_4: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => buf_addr_reg(7),
      I3 => buf_addr_reg(8),
      I4 => buffer_we_o_reg_1,
      I5 => buffer_we_o_reg_0,
...
stream: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer
     port map (
      ...
      buffer_we_o(0) => \^buffer_we_o\(0),
      buffer_we_o_reg_0 => \^trig_o_reg\,
      buffer_we_o_reg_1 => \^new_sample_o_reg\,
      s00_axi_aclk => s00_axi_aclk,
