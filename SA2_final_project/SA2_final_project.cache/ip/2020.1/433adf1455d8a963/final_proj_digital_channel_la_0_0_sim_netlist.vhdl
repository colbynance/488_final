...
new_sample_o_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer is
  port (
    ...
    buffer_di_o_reg_1 : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
stream: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sig_streamer
     port map (
      ...
      buffer_di_o_reg_1(0) => buffer_di_o_reg(0),
      s00_axi_aclk => s00_axi_aclk
    );
end STRUCTURE;
library IEEE;
